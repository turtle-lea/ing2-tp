...
def main()
  ...
  spurs = equipo_spurs
  #atenas = equipo_atenas
  bulls = equipo_bulls

  #spurs.asignarOponente(atenas)
  spurs.asignarOponente(bulls)

  #atenas.asignarOponente(spurs)
  bulls.asignarOponente(spurs)

  partido = Partido.new(spurs, bulls)
  #partido = Partido.new(spurs, atenas)
  partido.jugar
end
